            ...
            <div className="posts">
              ...
              <div className="bg-white p-4 rounded shaddow mt-3">
                  ...
                  <div className="mt-3">
                    <div>
                      <p className="text-dark">
                        ...
                        Veritatis expedita omnis saepe quod corporis alias velit
                        dolorum voluptate aut tenetur! Tempora facere amet
                        ratione eaque numquam! Aspernatur nisi modi impedit!
                      </p>
                      <img
                        src={rect}
                        alt="post image"
                ...
                <div
                  ...
                  style={{ background: "rgba(186, 217, 250, 1)" }}
                >
                  <div className="container">
                    <div className="d-flex">
                      ...
                      <div className="ms-auto p-2 bd-highlight">
                        <ul>
                          <li className="d-flex gap-2 ">
                            ...
                            <span className="text-success rounded-circle bg-white">
                              {like}
                            </span>
                      ...
                      {comments.map((text) => (
                        <div className="bg-white rounded p-2 mt-2">
                          ...
                          <div className="mt-3">
                            <div>
                              <div
                                className="comment-container p-3 rounded"
                      ...
                      <div className="comment-flexbox">
                        <div className="card mt-2">
                          <div className="row p-2 rounded">
                            ...
                            <div
                              className="col-auto bg-success text-white rounded-circle me-2 mt-1"
                              style={{ width: "4%", height: "30px" }}
                            >
                              <div
          ...
          <div className="col-sm-4">
                  ...
                  <div className="p-2 mt-4">
                    <div className="card mb-3 border-0">
                      <div className="row g-0">
                        <div
                          className="col-md-4 p-4 text-center"
                          style={{ background: "rgba(202, 227, 253, 1)" }}
                        >
                  ...
                  <div className="bd-highlight p-2">
                    <div className="card mb-3 border-0">
                      <div className="row g-0">
                        <div
                          className="col-md-4 p-4 text-center"
                          style={{ background: "rgba(253, 236, 206, 1)" }}
                        >
                          <i
                            className="bi bi-chat-fill fs-1"
                            style={{ color: "rgba(248, 159, 0, 1)" }}
                          ></i>
                        </div>
                        <div className="col-md-8">
                          <div className="card-body">
                  ...
                  <div className="p-2 bd-highlight">
                    <div className="card mb-3 border-0">
                      <div className="row g-0">
                        <div
                          className="col-md-4 p-4 text-center"
                          style={{ background: "rgba(213, 242, 224, 1)" }}
                        >
            ...
            <div className="card mt-4 border-0">
              ...
              >
                ...
                <Link
                  to={`/detailsdoctors`}
                  className="btn bg-white w-100 fs-4 fw-bold"
                  style={{ color: "#01D2BD" }}
                >
                  Talk to a doctor
                </Link>
